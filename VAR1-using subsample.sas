...
*VAR model using subsample 1985-2016 1990-2016 1990-2007 2007-2016
*===================================================================;
...
data data2007;             /*data2007 include dataset from 1990-2007*/
set data2015;
...
data data2015b;         /*data2015b include dataset from 2008-2015*/
set data2015;
if date>= "01OCT2007"d;
run;
...
data data2016b;         /*data2015b include dataset from 2008-2016*/
set data2016;
if date>= "01OCT2007"d;
run;
proc print data=data2016b;run;
